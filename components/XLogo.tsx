...
/** Official X mark (filled), drop-in for LucideIcon. */
export const XLogo = forwardRef<SVGSVGElement, LucideProps>(function XLogo(
  { size = 24, className, color = 'currentColor', style, ...rest },
  ref
) {
